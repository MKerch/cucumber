...
public class SuperSmoothieStepDefinition {
    ...
    public void the_following_drink_categories(List<Map<String, String>> dataTable) {
        dataTable.stream().forEach(drinkCategory -> {
    ...
    public void he_should_earn_points(Integer expected) {
        assertThat(michael.getPoints()).isEqualTo(expected);
    }
